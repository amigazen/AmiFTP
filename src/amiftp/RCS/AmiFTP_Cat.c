...
const struct FC_Type _MW_Connect = { 56, "_Connect" };
...
const struct FC_Type _MW_Connect = { 54, "_Connect" };
...
const struct FC_Type _MW_Connect = { 52, "_Connect" };
...
const struct FC_Type _MW_Connect = { 51, "_Connect" };
